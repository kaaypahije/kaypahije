...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    description: "Premium residential & commercial property consultants.",
    tags: ["Buy", "Rent", "Investment"],
    featured: true,
  },
  {
    id: "bright-academy",
...
export const categories = [
  ...
  { name: "Real Estate", icon: "Building2", color: "from-emerald-500 to-teal-500" },
